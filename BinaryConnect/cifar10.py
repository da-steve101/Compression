...
if __name__ == "__main__":
    ...
    new_param_values, filter_sizes = quantized_weights_pruning(params_binary, param_values, 0.65)
    #new_param_values, filter_sizes = real_weights_pruning(params_binary, param_values, 0.65)
    
    #new_param_values, filter_sizes = random_pruning(params_binary, param_values,0.65)
